...
int main(int argc, char **argv)
{
    ...
    // curve 2 in paper
    start.makeStartOrEnd(Eigen::Vector3d(-1.2, 0, 2.5), derivative_to_optimize);
    vertices.push_back(start);
    ...
    middle.addConstraint(mav_trajectory_generation::derivative_order::POSITION, Eigen::Vector3d(1.5, 0.2, 2.5));
    vertices.push_back(middle);
    ...
    end.makeStartOrEnd(Eigen::Vector3d(-.2, 0, 2.5), derivative_to_optimize);
    vertices.push_back(end);
